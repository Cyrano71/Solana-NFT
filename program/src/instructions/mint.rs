use {
    mpl_token_metadata::instructions::CreateMasterEditionV3Builder, solana_program::{
        account_info::{next_account_info, AccountInfo},
        entrypoint::ProgramResult,
        msg,
        program::invoke,
    }, spl_associated_token_account::instruction as associated_token_account_instruction, spl_token::instruction as token_instruction
};
...
pub fn mint_to(accounts: &[AccountInfo]) -> ProgramResult {
    ...
    let create_ix = CreateMasterEditionV3Builder::new()
            ...
            .token_program(*token_metadata_program.key)
            .system_program(*_system_program.key)
            .rent(Some(*rent.key))
            .max_supply(1).instruction();
